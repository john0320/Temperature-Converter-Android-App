 ...
 * 
 * Reference for class DoubleSeekBar:
...
public class MainActivity extends Activity implements Observer {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		seekBarFahrenheit.setMinTitle(getResources().getString(
				R.string.fahrenheit));
		...
		seekBarCelsius
				.registerOnChangeListenerMinSB(new OnSeekBarChangeListener() {
					@Override
		...
		seekBarFahrenheit
				.registerOnChangeListenerMinSB(new OnSeekBarChangeListener() {
					...
					public void onProgressChanged(SeekBar seekBar,
							int progress, boolean fromUser) {
						model.setFahrenheit(seekBarFahrenheit
								.getCurrentMinValue() + 0.0F);
					}
				});
	...
	/**
	 * The model has changed state! Refresh the activity.
	 */
	@Override
	...
	/**
	 * The update phase: GET data from the model SET view components to new
	 * values
	 */
